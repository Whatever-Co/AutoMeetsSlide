# Release AutoMeetsSlide

Release a new version of AutoMeetsSlide with automatic version bump and release notes.
...
grep 'MARKETING_VERSION:' macos-app/project.yml
...
Display:
- New version number
- Release URL: `https://github.com/Whatever-Co/AutoMeetsSlide/releases/tag/v<new_version>`
